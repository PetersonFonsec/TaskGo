import { Controller, Get, Post, Delete, Body, HttpCode, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class FavoritesController {
  ...
  async removeFavorite(
    ...
    return this.favoritesService.removeFavorite(clientId, createFavoriteDto.providerId);
  }
